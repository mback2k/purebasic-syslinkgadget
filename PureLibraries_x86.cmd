...
set PB_VC8=cl.exe -I"%PB_VS8%/VC/include" -I"%PB_LIBRARIES%" -DWINDOWS -DVISUALC -DX86 -I"%PB_PLATEFORM_SDK%/Include" -I"%PB_PLATEFORM_SDK%/Include/crt" -I. -I"%PB_DIRECTX9_SDK%/Include" /nologo /GS- /D_CRT_NOFORCE_MANIFEST /D_USE_32BIT_TIME_T
